...
def DecisionTree(bot: list, human: list, roc=False) -> tuple:
...
if __name__ == '__main__':
    ...
    score, matrix, report = DecisionTree(bot, human, roc=True)
    print('DecisionTree')
    print(f'accuracy: {score}')
    print(matrix)
    print(report)
    rocCurve(roc_stats, 'DecisionTree')